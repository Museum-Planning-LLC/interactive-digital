...
They are **interactive** (visitor agency, spatial or touch participation) and **digital** (capital-legible, specifiable, maintainable). Content domains vary: local history, science simulation, place memory, nautical themes, and others.
...
- Meaning can be **negotiated in the room**, not only delivered from a label

Not every entry resolves conflict or merges narratives. Some entries foreground **exploration** (e.g. flow, simulation). The principle is the same: avoid default expert monologue when the subject or site calls for plurality.
...
- Spec from the **same spatial read** as the study where possible
- **No substitute artwork** — reference installs link to author-owned builds
- **Offline-capable**, durable install targets for real galleries
- Support scoped as **project + optional light maintenance**, not a mandatory SaaS platform
